package Bio::KBase::ERDB_Service::Server;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::ERDB_Service::ServerContext->new(client_ip => $self->_plack_req->address);
...
package Bio::KBase::ERDB_Service::ServerContext;

use strict;

=head1 NAME

Bio::KBase::ERDB_Service::ServerContext
